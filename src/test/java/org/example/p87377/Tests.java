...
import org.example.p87377.Solution;
...
public class Tests {
    ...
    void t2() {
        assertThat(
                ...
                Set.of(Point.of(-1,1)) // 이렇게 하면 Point.of(-1,1)이 들어있는 Set을 만드는것과 똑같다.
        );
    }
    ...
    void t2_1() {
        assertThat(
                ...
                Set.of(Point.of(-1,1),Point.of(1,1)) // 이렇게 하면 Point.of(-1,1)이 들어있는 Set을 만드는것과 똑같다.
        );
    }
    ...
    void t2_2() {
        assertThat(
                ...
                Set.of(Point.of(0, 0)) // 이렇게 하면 Point.of(-1,1)이 들어있는 Set을 만드는것과 똑같다.
        );
    }
    ...
    @Test
    @DisplayName("positivePoints, [Point.of(2, 1), Point.of(-3, -5)]")
    void t5_3() {
        assertThat(
                new Solution().positivePoints(Set.of(Point.of(2, 1), Point.of(-3, -5)))
        ).isEqualTo(
                Set.of(Point.of(0, 0), Point.of(5, 6))
        );
    }
